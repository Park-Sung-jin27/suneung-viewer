...
**[A-1] 랜딩페이지 공부법 섹션 + CTA 수정**
- 담당: Code A
- 완료 기준: 공부법 섹션 노출 + "14일 무료로 시작하기" CTA 버튼 작동
- 상태: 진행
- 섹션 내용:
  ```
  제목: 지금 당신의 공부 방식, 이렇게 틀리고 있습니다
  ...
  CTA: [14일 무료로 시작하기 →] → 회원가입 → 바로 뷰어 진입
  ```
- 기존 "무료 진단" 버튼/섹션 제거
- 원칙: 기능 추가 없음. 텍스트/UI만. 3초 안에 이해 가능하게.
