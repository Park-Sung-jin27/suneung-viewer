...
const ANSWER_PDF = 'C:/Users/downf/OneDrive/Desktop/논리맵핑/국어 기출/국어 정답/2022학년도-대학수학능력시험-국어-답지.pdf';
const EXAM_PDF   = 'C:/Users/downf/OneDrive/Desktop/논리맵핑/국어 기출/2022학년도-대학수학능력시험-국어-문제.pdf';
const MAX_Q      = 34;
...
async function main() {
  ...
  if (fs.existsSync(answerPath)) {
    ...
    console.log(`[run_save] ✅ 정답키 저장 완료: ${answerPath} (${Object.keys(answerKey).length}문항)`);
  }
