 ...
 *     - Q1~15  : 화법과 작문 / 문법 (선택)
 *     - Q16~45 : 독서 + 문학  (범위만으로 독서/문학 구분 불가)
 *       🔴 정정 (D-86b) — 예전 주석은 Q16~34 라고 적혀 있었으나 **원본과 다르다.**
 *       구형은 45문항 체제이고 Q35~45 도 독서·문학이다. 2016_6월B 실측:
 *       [34~36] 현대소설 · [37~40] 고전소설 · [41~43] 현대시 · [44~45] 희곡.
 *       이 낡은 주석을 근거로 Q35~45 를 범위 밖으로 보면 뒷부분을 통째로 놓친다.
  ...
  if (exam_family === "suneung" || exam_family === "mock") {
    if (year != null) {
      if (year >= 2014 && year <= 2021) {
        ...
        notes.push(
          "old: Q1~15 선택(화작/문법), Q16~45 독서+문학 혼합 — 범위 기반 분류 금지 (D-86b 정정: 34→45)",
        );
      } else if (year >= 2022) {
        version = "new";
        range_based_split_allowed = true;
