...
//   ⓒ 파일명 — 기존 39개 자산이 전부 `<4자리 학년도>_<setId>_q<번호>_<용도>.png` 다.
//      발주의 `20209_` 는 5자리라 관례에서 벗어난다. **발주 문면을 그대로 따르되**
//      보고에 올린다. 바꾸려면 파일명과 이 상수 한 줄만 고치면 된다.
//
// ★ 도식 위치 (실측)
...
const FILE = "20209_r20209d_q41_bogi.png";   // 발주 문면 그대로
