...
console.log("\n1. [NONE, NONE, NONE] all high → majority_accepted, NONE, high");
{
  ...
  assertEqual(
    out.metadata.candidate_for_human_review,
    false,
    "candidate (et=NONE 면 empty 무관)",
  );
...
);
{
  ...
  assertEqual(
    out.final.rule_hits,
    [],
    "final.rule_hits = NONE majority intersection",
  );
  ...
  assertEqual(
    out.metadata.discarded_rule_hits,
    ["RULE_1"],
    "discarded = 소수 rule_hits",
  );
}
...
);
{
  ...
  assertEqual(
    out.metadata.discarded_rule_hits,
    null,
    "discarded null (5-3 미산출)",
  );
  assertEqual(
    out.metadata.candidate_for_human_review,
    false,
    "candidate false (needs_human은 별도)",
  );
...
);
{
  const out = applyMajority([
    {
      ...
      rule_hits: ["RULE_4_COMPOSITE_ERROR", "RULE_1_PAT_DEFINITION_MISMATCH"],
      reason: "x",
      confidence: "high",
    },
    {
  ...
  assertEqual(
    ...
    "final.rule_hits = intersection (RULE_1 빠짐)",
  );
  assertEqual(
    out.metadata.discarded_rule_hits,
...
);
{
  ...
  assertEqual(
    out.metadata.low_confidence_flag,
    false,
    "low_flag false (et=NONE 이라 empty intersection 무관)",
  );
  assertEqual(
    out.metadata.candidate_for_human_review,
    false,
...
);
{
  ...
  assertEqual(
    out.metadata.low_confidence_flag,
    true,
    "low_flag forced (pass=true malformed)",
  );
  assertEqual(
    out.metadata.candidate_for_human_review,
    false,
    "candidate false (intersection nonempty)",
  );
...
console.log("\n10. 3/3 일치 + rule_hits 다름 → intersection 보존");
{
  const out = applyMajority([
    {
      pass: false,
      error_type: "P_MISMATCH",
      rule_hits: ["RULE_1_PAT_DEFINITION_MISMATCH", "RULE_4_COMPOSITE_ERROR"],
      reason: "x",
      confidence: "high",
    },
    {
      pass: false,
      error_type: "P_MISMATCH",
      rule_hits: ["RULE_1_PAT_DEFINITION_MISMATCH", "RULE_5_OK_TRUE_WITH_PAT"],
      reason: "y",
      confidence: "high",
    },
    {
  ...
  assertEqual(
    out.final.rule_hits,
    ["RULE_1_PAT_DEFINITION_MISMATCH"],
    "intersection = [RULE_1_PAT_DEFINITION_MISMATCH]",
  );
  assertEqual(
    out.metadata.discarded_rule_hits,
    [
    ...
    "discarded = [RULE_4, RULE_5, RULE_6]",
  );
  assertEqual(out.metadata.low_confidence_flag, false, "low_flag false");
  assertEqual(
    out.metadata.candidate_for_human_review,
...
);
{
  const out = applyMajority([
    ...
    },
    {
      pass: false,
      error_type: "E_LOGIC_UNCLEAR",
      rule_hits: ["RULE_7_ANALYSIS_TOO_VAGUE", "RULE_3_CONDITION_MISSING"],
      reason: "y",
      confidence: "high",
    },
    {
      pass: false,
      error_type: "E_LOGIC_UNCLEAR",
      rule_hits: ["RULE_7_ANALYSIS_TOO_VAGUE", "RULE_5_OK_TRUE_WITH_PAT"],
      reason: "z",
      confidence: "high",
    },
  ]);
  assertEqual(
    ...
    "RULE_7_ANALYSIS_TOO_VAGUE 만 intersection",
  );
  assertEqual(
    out.metadata.discarded_rule_hits,
    ["RULE_3_CONDITION_MISSING", "RULE_5_OK_TRUE_WITH_PAT"],
    "RULE_3, RULE_5 discarded",
  );
  assertEqual(out.metadata.low_confidence_flag, false, "low_flag false");
  assertEqual(
    out.metadata.candidate_for_human_review,
...
console.log("\n14. discarded_rule_hits 정확성 검증 (사용자 명시 스펙)");
{
  const out = applyMajority([
    {
      pass: false,
      error_type: "E_COMPOSITE_ERROR",
      rule_hits: ["RULE_4_COMPOSITE_ERROR", "RULE_7_ANALYSIS_TOO_VAGUE"],
      reason: "x",
      confidence: "high",
    },
    {
  ...
  assertEqual(
    out.final.rule_hits,
    ["RULE_4_COMPOSITE_ERROR"],
    "intersection = [RULE_4_COMPOSITE_ERROR]",
  );
  assertEqual(
    out.metadata.discarded_rule_hits,
    ["RULE_7_ANALYSIS_TOO_VAGUE", "RULE_1_PAT_DEFINITION_MISMATCH"],
    "discarded = union - intersection",
  );
...
console.log("\n15. candidate_for_human_review 마커 검증 (사용자 명시 스펙)");
{
  const out = applyMajority([
    ...
    },
    {
      pass: false,
      error_type: "P_MISMATCH",
      rule_hits: ["RULE_5_OK_TRUE_WITH_PAT"],
      reason: "y",
      confidence: "mid",
    },
    {
      pass: false,
      error_type: "P_MISMATCH",
      rule_hits: ["RULE_6_PAT_MISSING_ON_OK_FALSE"],
      reason: "z",
      confidence: "mid",
    },
  ]);
