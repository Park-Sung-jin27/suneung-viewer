...
const SPEC = [
  ...
  // ── D-162 ① 2020_9월 팩 — 심사관 원본 대조 확정 ──────────────────────
  //   현행 근거가 s16「(중략)」 하나뿐이라 **화면에서 형광펜이 한 개도 안 켜졌다**
  //   (cs_effect_audit CS_ALL_NONHIGHLIGHTABLE). 본문 문장 3개로 바꾼다.
  //   심사관이 준 원문 어구가 세 문장에 실재하는지 기계 대조로 먼저 확인했다.
  {
    yk: "2020_9월", setId: "l20209d", qId: 42, num: 1, replace: true,
    csIds: ["l20209ds1", "l20209ds15", "l20209ds17"], csSpans: [],
    why: "심사관 원본 대조 확정. 선지는 「장면의 빈번한 교차를 통해 인물 간의 갈등을 입체적으로」인데 "
       + "지문은 장면을 교차하지 않고 지욱의 시선으로 이어진다. 그 흐름을 보이는 세 자리다 — "
       + "s1 「지욱은 차츰 선생의 그런 신념이 두려워지기 시작했다」 · "
       + "s15 「그의 부끄러움이 될 수는 없단 말인가」 · "
       + "s17 「이거 아무리 맘에 없는 웃음을 팔아먹고 사는 무식쟁이라고」. "
