...
function isCorrect(q, choiceNum) {
  ...
  return q.questionType === "positive"
    ? choice.ok === true
    : choice.ok === false;
}
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
          {keys.map((k) => {
            ...
            const pct =
              displayTotal > 0 ? Math.round((n / displayTotal) * 100) : 0;
            const p = P[k];
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div
            style={{ fontSize: "1.3rem", fontWeight: "800", color: "#111827" }}
          >
            풀이 완료
          </div>
        </div>
        ...
        {/* 2. 섹션별 결과 */}
        {[
          { label: SECTION_LABELS.reading, sets: readingSets },
          { label: SECTION_LABELS.literature, sets: litSets },
        ]
          ...
          >
            ...
            {topPat && P[topPat[0]] && (
              ...
              >
                ...
                이 {topPat[1]}건으로 가장 많습니다. {P[topPat[0]].desc}
              </div>
            )}
            <div
              style={{
