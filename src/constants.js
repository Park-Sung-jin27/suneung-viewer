...
export const RELEASED_SETS = [
  // 2027_6월 (8 set — 2026-06-08 release: 해설 3단 신기준 + 원문 전수 대조 + R3/V 22건 정박)
  "r20276a",
  "r20276b",
  "r20276c",
  "r20276d",
  ...
  "r2025a",
  "r2025d",
  "l2025b", // 2024수능 (7 set — r2024a/b/c/d 독서 + l2024a/b/c/d 문학; r2023d 같은 결손 0)
  "r2024b",
  "l2024d",
  ...
  // 2014수능A l2014a/b/c — 2026-06-10 격리 (스캔본 OCR 오염, 재구축 후 재출시)
  "l2015b",
  "l2016c",
  "l2016d",
  "l2016e",
  ...
  "l2021c",
  "l2021d",
  // r2014c — 2026-06-10 격리 (스캔본 OCR 오염, 재구축 후 재출시)
  "r2014f",
  "r2016a",
  "r2016d",
  "r2021c",
  ...
  // 53 setId = 40 신규 + 13 기존 RELEASE_SET_IDS 등록 안 RELEASED_SETS 미등록 보정.
  //   양쪽 동시 등록 정합 path 안 검수 배너 노출 사실 정합.
  // 2014_6월
  "l20146c", "l20146d",
  ...
  // 2021_6월 (l20216a/c/d 보정)
  "l20216a", "l20216c", "l20216d",
  // 2021_9월 (l20219b/c + r20216c + r20219c/d 보정)
  "l20219b", "l20219c",
  "r20216c",
  "r20219c", "r20219d",
];
