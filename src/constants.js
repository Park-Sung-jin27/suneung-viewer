...
export const RELEASED_SETS = [
  // 2026수능 (2 set — l2026a 문학 + s2 독서)
  "l2026a", "s2",
  // 2025수능 (2 set — 문학)
  "l2025b", "l2025c",
  // 2024수능 (2 set — r2024a/d 독서)
  "r2024a", "r2024d",
  // 2023수능 (3 set — l2023a 문학 + r2023a/b 독서)
  "l2023a", "r2023a", "r2023b",
  // 2022수능 (6 set — l2022a/b/c/d 문학 + r2022a/b 독서)
  "l2022a", "l2022b", "l2022c", "l2022d", "r2022a", "r2022b",
];
