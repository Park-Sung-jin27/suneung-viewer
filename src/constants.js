...
export const RELEASED_KEYS = new Set([
  ...
  "2022_6월::l20226b",
  "2022_9월::l20229d",
  // ── 2027_9월 (8) — 검수 배너 해제 (발주 F-54 ②, 2026-09-04) ──
  //   근거: D-199 검사 5축 전부 0 통과 — 빈칸소실·라벨혼입·구간부재·A′앵커·C중복등재.
  //   l20279b 밑줄 1건 수리 완료. 📌 인용 변형 5건은 심사관이 조건에서 제외했다
  //   (해설 본문 인용문이라 cs 정박·정답·해설 결론에 영향 없음, prod 점등 실측).
  //   ★ 이 목록은 배너 전용이다. 노출은 dataLoader.js 의 RELEASE_KEYS 가 정한다.
  "2027_9월::r20279a",
  "2027_9월::r20279b",
  "2027_9월::r20279c",
  "2027_9월::r20279d",
