...
export const RELEASED_SETS = [
  // 2026수능 (7 set — s1/s2/s3/s4 독서 + l2026a/b/c/d 문학; l2026a 정정 완료)
  "r2026a", "r2026b", "r2026c", "r2026d",
  "l2026a", "l2026b", "l2026c", "l2026d",
  // 2025수능 (8 set — r2025a/b/c/d 독서 + l2025a/b/c/d 문학)
  "r2025a", "r2025c", "r2025d",
  "l2025a", "l2025b", "l2025c", "l2025d",
  // 2024수능 (7 set — r2024a/b/c/d 독서 + l2024a/b/c/d 문학; r2023d 같은 결손 0)
  "r2024b",   "l2024a", "l2024d",
  // 2023수능 (7 set — r2023a/b/c 독서 + l2023a/b/c/d 문학; r2023d 만 hasFig 결손 보류)
  "r2023a", "r2023b", "r2023c",   "l2023a", "l2023b", "l2023c", "l2023d",
  // 2022수능 (8 set — 전부)
  ...
  "l20269a", "l20269b", "l20269c", "l20269d",
  // 2026 6월
  "r20266a", "r20266c", "r20266d",
  "l20266a", "l20266b", "l20266c", "l20266d",
  // 2025 9월
  "sep25_a", "sep25_b", "sep25_c", "sep25_d",
  "lsep25a", "lsep25b", "lsep25c", "lsep25d",
  // 2025 6월
  "r20256a", "r20256b", "r20256c",   "l20256a", "l20256b", "l20256c", "l20256d",
  // 2024 9월
  "r20249a", "r20249b", "r20249c", "r20249d",
  "l20249b", "l20249c", "l20249d",
  // 2024 6월
  "r20246a", "r20246b", "r20246c", "r20246d",
  "l20246a", "l20246b", "l20246c", "l20246d",
  // 2023 9월
  "r20239a", "r20239b", "r20239c", "r20239d",
  "l20239b", "l20239c", "l20239d",
  // 2023 6월
  "r20236a", "r20236b", "r20236c", "r20236d",
  "l20236a", "l20236b", "l20236c", "l20236d",
  // 2022 9월
  "r20229a", "r20229b", "r20229c", "r20229d",
  "l20229a", "l20229b",
  // 2022 6월
  "r20226a", "r20226b", "r20226c", "r20226d",
  "l20226a", "l20226c", "l20226d",
];
