    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '16px', marginBottom: '12px' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px' }}>
          ...
          <span style={{ fontSize: '20px', fontWeight: 700, color: colors.text }}>등급</span>
        </div>
      ...
      {/* 피드백 */}
      <p style={{ fontSize: '14px', color: colors.text, margin: '0 0 16px', lineHeight: 1.5 }}>
        {feedback}
      </p>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    fontSize: '12px',
                    transition: 'all 0.2s',
                    border: isMyGrade ? `2px solid ${colors.border}` : '2px solid transparent',
                  }}
                >
                  <div style={{ fontSize: '11px', marginBottom: '2px' }}>{g}등급</div>
                  <div style={{ fontSize: '13px', fontWeight: 700 }}>{cut}점+</div>
                </div>
              );
            })}
            <div style={{
              ...
              fontSize: '12px',
              border: grade === 8 ? `2px solid ${colors.border}` : '2px solid transparent',
            }}>
      ...
      <p style={{
        ...
        ※ 공통 영역(독서·문학) 34문항만 기준. 선택과목(화법과작문·언어와매체) 미포함.
        실제 등급은 표준점수·선택과목 포함 원점수로 결정되므로 참고용으로만 활용하세요.
