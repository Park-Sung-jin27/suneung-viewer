...
3. **비노출 text 환각 worklist** (render 직독 진행중):
   ...
   - **passage 비노출 0~0.2 triage**: **r20256d s21 '전전→전건 긍정식' 오타 교정(486be11)**. 나머지(l2025d s211/217/229·l20226a s20·l2020b s5·l2020c s14·l20166b s20·l20256a s101)=고전시가/대사 **옛한글·구어 변형 추정(acceptable)** — 포함도 0이라 spot-check 권고(미확정).
