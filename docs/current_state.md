...
- **다음 세션 첫 액션**: ① 옛한글 l2020a **배치2**(s14~s21, ㉢㉣ — 적용 전 토큰 잔존 검사 선행) ② `F_content_reversed` **비노출 23건** 세트 단위 재검 ③ legacy severity 등급표 → 2014 재전사 ④ 2015~2017 `MARKER_INTEGRITY` 78건 원인 분류(수능 완결 병목) ⑤ 도메인 A 4세트 이관(프론트 PatternReport 접두→배열 동시배포).
