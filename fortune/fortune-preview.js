...
(function(){
  ...
  function run(){
    ...
    if(cal === 'lunar'){
      try { solar = lunarToSolar(y, m, d, false); }
      catch(e){ alert('음력 변환에 실패했습니다. 양력으로 다시 시도해 주세요.'); return; }
    }
    ...
    $('fpPillJuga').textContent = '일주 ' + pillar.stemKo + pillar.branchKo + '(' + pillar.stem + pillar.branch + ')';
